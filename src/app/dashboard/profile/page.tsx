...
export default function ProfilePage() {
  ...
  const initials = profile?.full_name?.split(' ').map(n => n[0]).join('').toUpperCase() || profile?.username?.slice(0, 2).toUpperCase() || 'U'
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="space-y-2">
                ...
                <Input {...register('username')} placeholder="jdoe99" />
            ...
            <div className="space-y-2">
              <Label>Country</Label>
              <Input {...register('country')} placeholder="Brazil" />
            </div>
